  ...
  if (editingClient) {
    return {
      ...
      basicDetails: {
        ...
        workingUser: '', // Will be populated from relation
      ...
      loginDetails: {
        ...
        gstRegistrationType: editingClient.gst_registration_type || '',
        gstReturnFrequency: editingClient.gst_return_frequency || '',
      },
      attachments: [],
      portalUser: {
